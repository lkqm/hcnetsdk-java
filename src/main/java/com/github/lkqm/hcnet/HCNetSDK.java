...
//网络(NET_DVR_NETCFG_V30结构)
    ...
    public static final int COMM_ID_INFO_ALARM = 0x5200;//人脸身份证比对类型
...
//IPC接入参数配置
    ...
    public static class NET_DVR_HDCFG extends Structure {
        ...
        public NET_DVR_SINGLE_HD[] struHDInfo = (NET_DVR_SINGLE_HD[]) new NET_DVR_SINGLE_HD()
                .toArray(MAX_DISKNUM_V30);//硬盘相关操作都需要重启才能生效；
    }
...
*/
    ...
    public static class NET_DVR_EMAILCFG_V30 extends Structure {
        ...
        public NET_DVRRECEIVER[] struReceiver = (NET_DVRRECEIVER[]) new NET_DVRRECEIVER()
                .toArray(3);                            /* 最多可以设置3个收件人 */
...
//辅助输出参数配置
    ...
    public static class NET_DVR_DDNSPARA_V30 extends Structure {
        ...
        public NET_DVR_DDNS[] struDDNS = (NET_DVR_DDNS[]) new NET_DVR_DDNS()
                .toArray(MAX_DDNS_NUMS);//9000目前只支持前3个配置，其他配置保留
    ...
    public static class NET_DVR_CRUISE_RET extends Structure {
        ...
        public NET_DVR_CRUISE_POINT[] struCruisePoint = (NET_DVR_CRUISE_POINT[]) new NET_DVR_CRUISE_POINT()
                .toArray(32);            //最大支持32个巡航点
    }
